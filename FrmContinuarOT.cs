...
public class FrmContinuarOT : Form
{
    ...
    [field: AccessedThroughProperty("TxtHoraDatos")]
    internal virtual TextBox TxtHoraDatos
    {
        get; [MethodImpl(MethodImplOptions.Synchronized)]
        set;
    }
    ...
    internal virtual Button BtnContinuar
    {
        ...
        set
        {
            EventHandler value2 = BtnContinuar_Click;
            Button btnContinuar = _BtnContinuar;
            if (btnContinuar != null)
            {
                btnContinuar.Click -= value2;
            }
            _BtnContinuar = value;
    ...
    private void InitializeComponent()
    {
        ...
        this.TxtHoraDatos = new System.Windows.Forms.TextBox();
        ...
        this.GroupBox1.Controls.Add(this.TxtHoraDatos);
        ...
        this.DgvDatos.Columns.AddRange(this.ID, this.FOLIO, this.USUARIO, this.DESTINO, this.RAMPLA, this.FECHA, this.HORA);
        ...
        this.TxtHoraDatos.Location = new System.Drawing.Point(180, 389);
        this.TxtHoraDatos.Margin = new System.Windows.Forms.Padding(4);
        this.TxtHoraDatos.Name = "TxtHoraDatos";
        this.TxtHoraDatos.Size = new System.Drawing.Size(241, 22);
        this.TxtHoraDatos.TabIndex = 26;
        ...
        this.Label19.Text = "Continuar";
        this.BtnContinuar.Anchor = System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right;
        this.BtnContinuar.BackgroundImage = Sistema_Estiba_PDQ.My.Resources.Resources.IcoActualizar;
        ...
        base.Name = "FrmContinuarOT";
        base.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
        this.Text = "Continuar Ordenes De Trabajo";
    ...
    private void Mostrar_Datos()
    {
        ...
        while (vReader.Read())
        {
            DgvDatos.Rows.Add(vReader.GetString(0), vReader.GetString(1), vReader.GetString(2), vReader.GetString(3), vReader.GetString(4), vReader.GetString(5), vReader.GetString(6));
        }
        vReader.Close();
    ...
    private void DgvDatos_CellClick(object sender, DataGridViewCellEventArgs e)
    {
        ...
        TxtHoraDatos.Text = DgvDatos.CurrentRow.Cells["hora"].Value.ToString();
        Mostrar_Detalles();
    }
